            ...
            <div class="services row mb-5">
                <div class="col-md-3 col-sm-6 mb-md-0 mb-4">
                    <div class="service-item">
                        <Icon name="carbon:delivery-parcel" size="60" class="text-info"/>
                ...
                <div class="col-md-3 col-sm-6 mb-md-0 mb-4">
                    <div class="service-item">
                        <Icon name="material-symbols:update-rounded" size="60" class="text-info"/>
                ...
                <div class="col-md-3 col-sm-6 mb-md-0 mb-4">
                    <div class="service-item">
                        <Icon name="bi:headset" size="60" class="text-info"/>
                ...
                <div class="col-md-3 col-sm-6 mb-md-0 mb-4">
                    <div class="service-item">
                        <Icon name="material-symbols:check-circle-outline-rounded" size="60" class="text-info"/>

                        <div class="service-item-body">
                            <h6>100% خالص و دستچین </h6>
